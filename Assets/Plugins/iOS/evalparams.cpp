...
fgrpindex_t EvalParams::RECKLESS_ADVANCE_SCALE;
...
void EvalParams::init()
{
	...
	RECKLESS_ADVANCE_SCALE = fset.add("RECKLESS_ADVANCE_SCALE");
  ...
  RAB_YDIST_VALUES = fset.add("RAB_YDIST_VALUES",8);
	...
	g = RECKLESS_ADVANCE_SCALE;  f = fset.get(g); priorMean[f] = 0; priorStdev[f] = 1.0*2; addIndividualBasis(g, 0.2, false);
